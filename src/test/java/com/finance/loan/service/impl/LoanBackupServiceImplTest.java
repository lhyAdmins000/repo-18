...
class LoanBackupServiceImplTest {

    @Mock
    private LoanBackupRepository repository;

    @InjectMocks
    private LoanBackupServiceImpl service;

    private LoanBackupEntity createEntity() {
        LoanBackupEntity e = new LoanBackupEntity();
        e.setId(1L);
        e.setName("test");
        e.setStatus("active");
    ...
    void testGetAll_0() {
        ...
        List<LoanBackupResponse> result = service.getAll();
    ...
    void testGetById_0() {
        ...
        LoanBackupResponse result = service.getById(0L);
    ...
    void testCreate_0() {
        ...
        LoanBackupResponse result = service.create(new LoanBackupRequest());
        assertNotNull(result);
    }
    ...
    void testGetById_1() {
        ...
        LoanBackupResponse result = service.getById(1L);
        assertNotNull(result);
    }
    ...
    void testGetById_2() {
        ...
        LoanBackupResponse result = service.getById(2L);
        assertNotNull(result);
    }
    ...
    void testGetById_3() {
        ...
        LoanBackupResponse result = service.getById(3L);
        assertNotNull(result);
    }
    ...
    void testGetById_4() {
        ...
        LoanBackupResponse result = service.getById(4L);
        assertNotNull(result);
    }
    ...
    void testGetById_5() {
        ...
        LoanBackupResponse result = service.getById(5L);
        assertNotNull(result);
    }
    ...
    void testGetById_6() {
        ...
        LoanBackupResponse result = service.getById(6L);
        assertNotNull(result);
    }
    ...
    void testGetById_7() {
        ...
        LoanBackupResponse result = service.getById(7L);
        assertNotNull(result);
    }
