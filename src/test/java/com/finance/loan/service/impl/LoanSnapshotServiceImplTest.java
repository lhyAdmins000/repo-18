...
class LoanSnapshotServiceImplTest {

    @Mock
    private LoanSnapshotRepository repository;

    @InjectMocks
    private LoanSnapshotServiceImpl service;

    private LoanSnapshotEntity createEntity() {
        LoanSnapshotEntity e = new LoanSnapshotEntity();
        e.setId(1L);
        e.setName("test");
        e.setStatus("active");
    ...
    void testGetAll_0() {
        ...
        List<LoanSnapshotResponse> result = service.getAll();
    ...
    void testGetById_0() {
        ...
        LoanSnapshotResponse result = service.getById(0L);
    ...
    void testCreate_0() {
        ...
        LoanSnapshotResponse result = service.create(new LoanSnapshotRequest());
        assertNotNull(result);
    }
    ...
    void testGetById_1() {
        ...
        LoanSnapshotResponse result = service.getById(1L);
        assertNotNull(result);
    }
    ...
    void testGetById_2() {
        ...
        LoanSnapshotResponse result = service.getById(2L);
        assertNotNull(result);
    }
    ...
    void testGetById_3() {
        ...
        LoanSnapshotResponse result = service.getById(3L);
        assertNotNull(result);
    }
    ...
    void testGetById_4() {
        ...
        LoanSnapshotResponse result = service.getById(4L);
        assertNotNull(result);
    }
    ...
    void testGetById_5() {
        ...
        LoanSnapshotResponse result = service.getById(5L);
        assertNotNull(result);
    }
    ...
    void testGetById_6() {
        ...
        LoanSnapshotResponse result = service.getById(6L);
        assertNotNull(result);
    }
    ...
    void testGetById_7() {
        ...
        LoanSnapshotResponse result = service.getById(7L);
        assertNotNull(result);
    }
