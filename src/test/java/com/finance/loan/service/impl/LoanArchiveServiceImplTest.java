...
class LoanArchiveServiceImplTest {

    @Mock
    private LoanArchiveRepository repository;

    @InjectMocks
    private LoanArchiveServiceImpl service;

    private LoanArchiveEntity createEntity() {
        LoanArchiveEntity e = new LoanArchiveEntity();
        e.setId(1L);
        e.setName("test");
        e.setStatus("active");
    ...
    void testGetAll_0() {
        ...
        List<LoanArchiveResponse> result = service.getAll();
    ...
    void testGetById_0() {
        ...
        LoanArchiveResponse result = service.getById(0L);
    ...
    void testCreate_0() {
        ...
        LoanArchiveResponse result = service.create(new LoanArchiveRequest());
        assertNotNull(result);
    }
    ...
    void testGetById_1() {
        ...
        LoanArchiveResponse result = service.getById(1L);
        assertNotNull(result);
    }
    ...
    void testGetById_2() {
        ...
        LoanArchiveResponse result = service.getById(2L);
        assertNotNull(result);
    }
    ...
    void testGetById_3() {
        ...
        LoanArchiveResponse result = service.getById(3L);
        assertNotNull(result);
    }
    ...
    void testGetById_4() {
        ...
        LoanArchiveResponse result = service.getById(4L);
        assertNotNull(result);
    }
    ...
    void testGetById_5() {
        ...
        LoanArchiveResponse result = service.getById(5L);
        assertNotNull(result);
    }
    ...
    void testGetById_6() {
        ...
        LoanArchiveResponse result = service.getById(6L);
        assertNotNull(result);
    }
    ...
    void testGetById_7() {
        ...
        LoanArchiveResponse result = service.getById(7L);
        assertNotNull(result);
    }
